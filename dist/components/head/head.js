...
var Head = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Head() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Head.__proto__ || Object.getPrototypeOf(Head)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__20", "banner"], _this.customComponents = ["HeadSwiper"], _temp), _possibleConstructorReturn(_this, _ret);
  }
